...
MOODLE_ORIGIN = "https://moodle.hku.hk"
...
class BrowserCommandName(str, Enum):
    ...
    OPEN_MOODLE = "hku.open_moodle"
    LIST_PORTAL_NOTICES = "portal.list_notices"
    ...
    BOOK_LIBRARY_SPACE_ONCE = "library.spaces.book_exact_once"
